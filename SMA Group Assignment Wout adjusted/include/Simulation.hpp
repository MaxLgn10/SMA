...
public:
    ...
    int W = 60;       // 8 warmup + 52 data weeks
    int R = 100;
    int warmupWeeks = 8;
    int rule = 1;
    ...
    // Fix 2: six independent CRN streams, one per simulation component.
    std::mt19937 rng_elective_arrival;
    std::mt19937 rng_urgent_arrival;
    std::mt19937 rng_elective_scan;
    std::mt19937 rng_urgent_scan;
    std::mt19937 rng_tardiness;
    std::mt19937 rng_noshow;
    ...
    void seed_streams(int base_seed);
    void allocateMovingArrays();
    void setWeekSchedule();
    void resetSystem();
    int getRandomScanType(std::mt19937& rng);
